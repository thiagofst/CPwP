...
os.chdir('/home/volkoff/VVV/MSC/Fourier')
...
plt.tight_layout()
plt.savefig('gaussian.png', dpi = 150)
plt.close() # plt.show()
...
plt.tight_layout()
plt.savefig('rectangular.png', dpi = 150)
plt.close() # plt.show()
...
plt.tight_layout()
plt.savefig('triangular.png', dpi = 150)
plt.close() # plt.show()
...
plt.tight_layout()
plt.savefig('sawtooth.png', dpi = 150)
plt.close() # plt.show()
