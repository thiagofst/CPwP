...
s = ascii.read('/home/volkoff/VVV/MSC/Astro/uka0iv.dat')
(wav, flux) = (s['lk'], s['ukf_a0iv'])
...
plt.title(r'A0$-$IV star', fontsize = 12, loc = 'left')
plt.xlim(3500, 8000);
#plt.ylim(0, 2.6)
...
plt.tight_layout(); plt.savefig('balmer.eps'); plt.show()
